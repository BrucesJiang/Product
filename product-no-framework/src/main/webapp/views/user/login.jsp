                                ...
                                <tr>
                                            ...
                                            <table width="100%" border="0" cellspacing="0">
                                                <tr>
                                                    <td style="text-align:center; padding-top:20px"><img
                                                            src="/public/images/logintitle.gif" width="150"
                                                            height="30"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table width="80%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td colspan="2"
                                                                    style="padding-top:10px; text-align:center"><input
                                                                        ...
                                                                        src="/public/images/loginbutton.gif" width="83"
                                                                        height="22"/>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="padding-top:10px"><img
                                                                        src="/public/images/loginline.gif" width="241"
                                                                        height="10"/>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2"
                                                                    style="padding-top:10px; text-align:center"><a
                                                                        href="${pageContext.request.contextPath}/views/user/register.jsp"><img
                                                                        name="image"
                                                                        src="/public/images/signupbutton.gif"
                                                                        width="135"
                                                                        height="33"/>
                                                                </a></td>
                                                            </tr>
                                    ...
                                    <td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
                                        ...
                                        <p style="text-align:right">
                                            <a href="${pageContext.request.contextPath}/views/user/register.jsp"><img
                                                    src="/public/images/signupbutton.gif" width="135" height="33"/> </a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
